  ...
  <div class="app-container">
    ...
    <div class="app-content">
      <div class="app-content-header">
        ...
        <button class="app-content-headerButton" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Product</button>
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content" style="color: white">
              ...
              <div class="modal-body">
                <form action="./" method="post" id ="add_product_form" class="add_product_form" enctype="multipart/form-data">

                  <div class="custom__image-container" id="custom__image-container">
                    <p>Add image</p>
                    <label id="image-label" for="image">+</label>
                  ...
                  <div class="input-container">
                    <div class="form-group">
                      ...
                      <input type="text" name="nameInput" class="form-control" id="nameInput" placeholder="Enter product name" required>
                    </div>
                    <div class="form-group">
                      <label for="cateogryInput">Category</label>
                      <input type="text" name="categoryInput" class="form-control" id="categoryInput" placeholder="Enter product cateogry"required>
                    </div>
                    <div class="form-group">
                      <label for="stockInput">Stock</label>
                      <input type="number" name="stockInput" class="form-control" id="stockInput" placeholder="Enter stock" required>
                    </div>
                    <div class="form-group">
                      <label for="priceInput">Price</label>
                      <input type="number" name="priceInput" class="form-control" id="priceInput" placeholder="Enter product price">
                    </div>
                    <div class="form-check">
                      <input type="checkbox" name="statusInput" class="form-check-input" id="statusInput">
              ...
              <div class="modal-footer">
                <button type="submit" name="submit" id="submitButton" class="btn btn-primary" form="add_product_form" data-bs-dismiss="modal">Send</button>
              </div>
            </div>
          </div>
        </div>
